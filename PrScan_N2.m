function Table=PrScan_N2(ch,n,k,r,m,P)
% -------------------------------------------------------------------------
%
%       Table=PrScan_N2(ch,n,k,r,m,P)
%
%           This function returns the probabilities of number of windows 
%           of length at most k containing at least r successes (occurence 
%           of state 'ch') where recounting starts only after the 
%           completion of k-tuple of successive trials encountered in n 
%           trials with statespace S={0,1,...,m} and transition probability
%           matrix P, assuming X0=0.
%
%       Example:
%         Input 
